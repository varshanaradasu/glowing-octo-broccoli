...
|----------------------|------------------------|---------------------|
| Year of Release      |Python 2 was released   |Python 3 was released|
|                      |  in the year 2000.     | in the year 2008.   |
| “Print” Keyword      |In Python 2, print is   |In Python 3, print is|
|                      |considered to be a      |considered to be a   |
|                      |statement and not a     |function and not a   |
|                      |function.               |statement.           |
|Storage of Strings    |In Python 2, strings are|In Python 3, strings |
|                      |stored as ASCII default.|are stored as UNICODE|
|                      |                        |by default.          |
|Exceptions            |In Python 2, exceptions |In Python 3,exception|
|                      |are enclosed  notations.|are enclosed in      |
|                      |                        |parentheses.         |
